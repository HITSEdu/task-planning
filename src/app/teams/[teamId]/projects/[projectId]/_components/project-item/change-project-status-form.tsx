...
export default function ChangeProjectStatusForm({ project }: ChangeProjectStatusFormProps) {
  const [selectedStatus, setSelectedStatus] = useState<Statuses>(project.status as Statuses)
  const [state, action, pending] = useActionState(changeProjectStatusAction, {})
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Изменить статус проекта</DialogTitle>
        </DialogHeader>
